...
import Profile from '../../../components/Consultant/My profile/Profile';
import AddSlots from '../../../components/Consultant/slots/AddSlots';
...
function CounselorProfile() {
  ...
  return (
   ...
   { decoded && <div className="flex flex-wrap ">
          ...
          <div className="px-4 py-5 flex-auto">
            ...
            <div className={openTab === 1 ? "block" : "hidden"} id="link1">
              ...
              <div className={openTab === 3 ? "block" : "hidden"} id="link3">
                <AddSlots   id = {decoded && decoded.user._id} />
              </div>
          </div>
        </div>
      </div>
