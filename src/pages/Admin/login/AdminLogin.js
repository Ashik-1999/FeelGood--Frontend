  ...
  return (
    <div>
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          {/* form */}
          <div className="md:w-[600px] px-8 md:px-16">
            <h2 className="font-bold text-2xl text-center text-[#002D74]">Admin Login</h2>
           
            <form  className="flex flex-col gap-4">
              <input className="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Email" />
              <div className="relative">
                <input className="p-2 rounded-xl border w-full" type={boolean?"text":"password"} name="password" placeholder="Password" />
